		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				<form method="post" action="" name="searchf">
					<input type="text" name="search" placeholder="جستجو" class="search fleft" <?php if($s!=false) echo 'value="'.$s.'"'; ?>/>
				</form>
				...
				<?php
				if($role == 1 || $role == 2)
					echo '<a href="" name="delete-all" class="btn red disabled fright del"><i class="fa fa-close"></i> پاک کردن سیستم</a>';
				?>
				<a href="new-item.php" class="btn green enable fright"><i class="fa fa-arrow-down"></i> اضافه کردن سیستم </a>
				<!-- <a href="" name="check-out-all" class="btn blue disabled fright"><i class="fa fa-arrow-up"></i> ویرایش </a> -->
			...
			<table border="1" rules="rows" id="items">
				<thead>
					<tr>
						...
						<td width="6%">شناسه</td>
						<td width="10%">نام فرد</td>
						<td width="10%">گروه</td>
						<td width="10%">تیسی</td>
						<td width="10%">کیبورد</td>
						<td width="10%">مانیتور</td>
						<td width="10%">ای پی فون</td>
						<td width="10%">IP</td>
						<td width="11%">Mac</td>
						<td width="15%">امکانات</td>
					</tr>
				</thead>
...
?>
					<tr data-type="element" data-id="<?php echo $item->id; ?>">
						...
						<td class="hover" data-type="cat"><?php $_items->get_category_name($item->category); ?></td>
						<td class="hover" data-type="tc"><?php echo $item->Tc; ?></td>
						<td class="hover" data-type="keyboard"><?php echo $item->Keyboard; ?></td>
						<td class="hover" data-type="monitor"><?php echo $item->Monitor; ?></td>
						<td class="hover" data-type="ipphone"><?php echo $item->IPphone ?></td>
