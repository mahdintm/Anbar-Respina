			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="account-settings">
						...
						?>
						<br />
						<input type="submit" name="invento-settings-savesettings" class="ni btn blue" value="Save Settings" />
					</form>
				</div>
			<div>
			<?php } ?>
			
			<h2 class="noborder">تغییر کلمه عبور</h2>
			<span class="downtitle">اگر نمی خواهید رمز عبور خود را تغییر دهید ، کادرهای زیر را خالی بگذارید.</span>
			<div class="center">
				<div class="form">
					<form method="post" action="" name="change-password">
						...
						کلمه عبور را مجددا وارد کنید:<br />
						<div class="ni-cont">
							<input type="password" name="rnew-password" class="ni" />
						</div>
						<br />
						<input type="submit" name="invento-settings-changepass" class="ni btn blue" value="Reset Password" />
					</form>
				</div>
			</div>
			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="invento-settings">
						<div class="checkbox"><input type="checkbox" name="allow-namechange" value="y" <?php if($sitedata[0] == 'y') echo 'checked'; ?>/>به کاربران اجازه دهید نام خود را تغییر دهند<br /></div>
						<div class="checkbox"><input type="checkbox" name="allow-emailchange" value="y" <?php if($sitedata[1] == 'y') echo 'checked'; ?>/>به کاربران اجازه دهید ایمیل خود را تغییر دهند<br /></div>
						<br />
						<input type="submit" name="invento-settings-save" class="ni btn blue" value="Save Settings" />
					</form>
				</div>
			</div>
			<?php } ?>
