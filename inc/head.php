<?php
$_titles = array('','صفحه اصلی','اضافه کردن سیستم','سیستم ها','انبار','Check-Out Item','گزارشات','دسته بندی','دسته بندی جدید','کاربران','کاربر جدید','ویرایش کاربر','تنظیمات','ویرایش سیستم','ویرایش دسته بندی','اطلاعات دسته بندی','اطلاعات سیستم','اطلاعات کاربر');
$_title = $_titles[$_page];
?>
	<meta charset="utf-8" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=no" />
	<title>رسپینا - <?php echo $_title; ?></title>
