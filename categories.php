	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				<?php
				if($role == 1 || $role == 2)
					echo '<a href="new-category.php" name="new-cat" class="btn blue fright"><i class="fa fa-plus"></i>New Category</a>';
				?>
			</div>
			...
			<table border="1" rules="rows" id="categories">
				<thead>
					<tr>
						...
						<td width="6%">شناسه</td>
						<td width="28%">نام دسته بندی</td>
						<td width="19%">مکان</td>
						<td width="14%">تعداد</td>
						<td width="17%">کل موارد</td>
						<td width="11%">اقدامات</td>
					</tr>
				</thead>
				<tbody>
<?php
