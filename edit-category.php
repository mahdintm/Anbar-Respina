			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="edit-cat" data-id="<?php echo $cat->id; ?>">
						...
						<span class="ncat-desc-left">اطلاعات دسته بندی (<?php echo 400-strlen($cat->descrp); ?> کلمه):</span><br />
						<div class="ni-cont">
							<textarea name="ncat-descrp" class="ni"><?php echo $cat->descrp; ?></textarea>
						</div>
						<input type="submit" name="ncat-submit" class="ni btn blue" value="ذخیره" />
					</form>
				</div>
			</div>
		</div>
